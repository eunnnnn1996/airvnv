	...
	<div class="main-content-inner">
		...
		<div class="city-category">
			<ul style="padding-left:30px; width:1200px;">
				...
				<li>
				<a href="${pageContext.request.contextPath}/house/worldList.do?market_type=${param.market_type}&board_type=${param.board_type}&day_type=${param.day_type}&price=${param.price}">
					<div>
